                ...
                <div className="filters-body">
                    <div className="filters-body-container">
                        <fieldset className="filters-fieldset-types">
                            ...
                            { props.items.map(item => <TypeFilterOption key={item.id} details={item} handleChange={props.handleChange}/>) }
                        </fieldset>
                    </div>
                </div>}
        </form>
...
const TypeFilterOption = (props) => (
    <span className="filters-checkbox-group">
        <input id={props.details.id} type="checkbox" value={props.details.id} onChange={props.handleChange}/>
        <label htmlFor={props.details.id}><span className={"icon-" + props.details.icon}>{props.details.name}</span></label>
    </span>
);
